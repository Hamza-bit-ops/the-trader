            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl p-8 rounded-3xl shadow-lg border border-slate-700/50 hover:border-cyan-400/30 transition-all duration-500">
                ...
                <div className="flex space-x-4 mb-4">
                  ...
                  <a 
                    href="#" 
                    className="w-12 h-12 bg-gradient-to-r from-blue-400 to-cyan-500 rounded-full flex items-center justify-center hover:from-blue-300 hover:to-cyan-400 transition-all duration-300 transform hover:scale-110 shadow-lg"
                  >
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    href="#" 
                    className="w-12 h-12 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center hover:from-green-400 hover:to-green-500 transition-all duration-300 transform hover:scale-110 shadow-lg"
                  >
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
